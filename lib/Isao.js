...
import { Animated, Easing, TextInput, TouchableWithoutFeedback, View, StyleSheet } from "react-native";
...
export default class Isao extends BaseInput {
  ...
  render() {
    const { label, style: containerStyle, height: inputHeight, inputStyle, labelStyle, activeColor, passiveColor } = this.props;
