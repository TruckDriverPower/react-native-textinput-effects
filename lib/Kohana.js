...
export default class Kohana extends BaseInput {
  ...
  render() {
    const { iconClass: Icon, iconColor, iconSize, iconName, label, style: containerStyle, inputStyle, labelStyle } = this.props;
    ...
    return (
      <View style={[styles.container, containerStyle]} onLayout={this._onLayout}>
        ...
        <TextInput ref="input" {...this.props} style={[styles.textInput, inputStyle]} value={value} onBlur={this._onBlur} onFocus={this._onFocus} onChange={this._onChange} underlineColorAndroid={"transparent"} />
      </View>
    );
  }
}
