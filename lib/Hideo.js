...
export default class Hideo extends BaseInput {
  ...
  render() {
    const { iconClass, iconColor, iconSize, iconName, iconBackgroundColor, style: containerStyle, inputStyle, height: inputHeight } = this.props;
    ...
    return (
      <View style={[styles.container, containerStyle]} onLayout={this._onLayout}>
        ...
        <TextInput ref="input" {...this.props} style={[styles.textInput, inputStyle]} value={value} onBlur={this._onBlur} onChange={this._onChange} onFocus={this._onFocus} underlineColorAndroid={"transparent"} />
      </View>
    );
  }
}
