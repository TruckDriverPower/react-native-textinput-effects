...
export default class Makiko extends BaseInput {
  ...
  render() {
    const { iconClass, iconColor, iconName, iconSize, iconWidth, style: containerStyle, height: inputHeight, inputStyle, label, labelStyle } = this.props;
      ...
      <View style={[styles.container, containerStyle]} onLayout={this._onLayout}>
        <TouchableWithoutFeedback onPress={this.focus}>
          ...
          >
            ...
            />
            <Text style={[styles.label, labelStyle, { left: iconWidth, color: iconColor }]}>
              {label}
            </Text>
          </View>
