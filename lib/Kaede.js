...
export default class Kaede extends BaseInput {
  ...
  render() {
    const { label, style: containerStyle, inputStyle, labelStyle, height: inputHeight } = this.props;
    ...
    return (
      <View style={containerStyle} onLayout={this._onLayout}>
        ...
        >
          <TextInput ref="input" {...this.props} style={[styles.textInput, inputStyle, { height: inputHeight }]} value={value} onBlur={this._onBlur} onFocus={this._onFocus} onChange={this._onChange} underlineColorAndroid={"transparent"} />
        </Animated.View>
